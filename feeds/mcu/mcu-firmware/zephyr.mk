...
$(foreach TARGET,$(TARGETS_HELLOWORLD_ZEPHYRV33X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.3.x,hello_world,$(TARGET))))

$(foreach TARGET,$(TARGETS_HELLOWORLD_ZEPHYRV35X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.5.x,hello_world,$(TARGET))))

$(foreach TARGET,$(TARGETS_HELLOWORLD_ZEPHYRV36X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.6.x,hello_world,$(TARGET))))

$(foreach TARGET,$(TARGETS_HELLOWORLD_ZEPHYRMAIN),\
  $(eval $(call mcu-fw-generate,zephyr-main,hello_world,$(TARGET))))
...
$(foreach TARGET,$(TARGETS_HCIUART_ZEPHYRV33X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.3.x,hci_uart,$(TARGET))))

$(foreach TARGET,$(TARGETS_HCIUART_ZEPHYRV35X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.5.x,hci_uart,$(TARGET))))

$(foreach TARGET,$(TARGETS_HCIUART_ZEPHYRV36X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.6.x,hci_uart,$(TARGET))))

$(foreach TARGET,$(TARGETS_HCIUART_ZEPHYRMAIN),\
  $(eval $(call mcu-fw-generate,zephyr-main,hci_uart,$(TARGET))))
...
$(foreach TARGET,$(TARGETS_HCIUSB_ZEPHYRV33X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.3.x,hci_usb,$(TARGET))))

$(foreach TARGET,$(TARGETS_HCIUSB_ZEPHYRV35X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.5.x,hci_usb,$(TARGET))))

$(foreach TARGET,$(TARGETS_HCIUSB_ZEPHYRV36X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.6.x,hci_usb,$(TARGET))))

$(foreach TARGET,$(TARGETS_HCIUSB_ZEPHYRMAIN),\
  $(eval $(call mcu-fw-generate,zephyr-main,hci_usb,$(TARGET))))
...
$(foreach TARGET,$(TARGETS_MCUBOOT_ZEPHYRV35X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.5.x,mcuboot,$(TARGET))))

$(foreach TARGET,$(TARGETS_MCUBOOT_ZEPHYRV36X),\
  $(eval $(call mcu-fw-generate,zephyr-v3.6.x,mcuboot,$(TARGET))))

$(foreach TARGET,$(TARGETS_MCUBOOT_ZEPHYRMAIN),\
  $(eval $(call mcu-fw-generate,zephyr-main,mcuboot,$(TARGET))))
